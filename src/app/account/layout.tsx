...
export default async function AccountLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <section className="account-shell max-w-content mx-auto px-8 py-14 max-sm:px-5 max-sm:py-10">
      <div className="grid gap-12 max-lg:gap-8 lg:grid-cols-[220px_1fr]">
        <aside className="flex flex-col gap-1 lg:sticky lg:top-8 self-start">
