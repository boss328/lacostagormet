...
export function FilterSelect({
  ...
  return (
    <select
      ...
      disabled={isPending}
      className="font-display italic text-ink bg-transparent border-b border-rule pb-1 pr-6 pl-1 cursor-pointer hover:border-ink focus:border-brand-deep focus:outline-none transition-colors duration-200"
      style={{
        fontSize: '16px',
